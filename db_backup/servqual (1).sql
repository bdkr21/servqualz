...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2025 at 01:16 PM
...
(12, 'z', 'empathy', 'publish', 'Eyelashes & Brow Styling');
...
(7, 'assurance', 'Eyelashes a', 'Eyelashes a', 'Aktif', 'Eyelashes & Brow Styling');
...
(24, 'seyeon', '0813-229-00800', '2021-08-12', 'Eyelashes & Brow Styling');
...
(27, 24, '2025-08-04', 'lunas', 'Eyelashes & Brow Styling', 'TR012');
...
ALTER TABLE `kuesioner`
  ...
  ADD KEY `fk_kuesioner_data_kuesioner` (`id_data_kuesioner`),
  ADD KEY `fk_kuesioner_pelanggan` (`id_pelanggan`);
...
--
ALTER TABLE `data_kuesioner`
  MODIFY `id_data_kuesioner` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `data_pernyataan`
--
ALTER TABLE `data_pernyataan`
  MODIFY `id_data_pernyataan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `kuesioner`
  ADD CONSTRAINT `fk_kuesioner_data_kuesioner` FOREIGN KEY (`id_data_kuesioner`) REFERENCES `data_kuesioner` (`id_data_kuesioner`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_kuesioner_pelanggan` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`id_pelanggan`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
